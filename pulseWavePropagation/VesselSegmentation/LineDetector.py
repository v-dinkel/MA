#Vessel Segmentation Using Alaudin's method
...
from GetLineMask import getLinemask
...
def lineDetector(Image, Mask, threshold):
    ...
    filterNumber = 18
    for i in xrange(1, winSize+1, step):
        L = i
        ...
        for m in xrange(0, filterNumber):
...
def lineDetector2(Img_green_reverse0, Mask):
