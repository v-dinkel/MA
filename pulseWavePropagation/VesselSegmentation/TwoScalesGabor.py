...
def twoScalesGabor(Img_reverse, Mask):
    ...
    Img_small = cv2.resize(Img_reverse, fx=0.5, fy=0.5, dsize=None)#dsize=(120, 120)
    Mask_small = cv2.resize(Mask, fx=0.5, fy=0.5, dsize=None)#dsize=(120, 120)
...
#####################################
    ...
    # filteredImg1_smalltoLarge = cv2.resize(filteredImg1_small, dsize=(width, height))
    # filteredImg1_final = np.maximum(filteredImg1_large, filteredImg1_smalltoLarge)
